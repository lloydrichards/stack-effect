...
| `--package-manager choice` | Override the default package manager. bun and deno use their own package managers; pnpm/npm imply --runtime node. (choices: bun, deno, pnpm, npm) |
